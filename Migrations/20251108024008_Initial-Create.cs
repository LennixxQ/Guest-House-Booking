        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuestHouseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    GuestHouseName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuestHouses_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BedId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    BedLabel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogDetail = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LogDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LogTable", x => x.AuditId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuestHouses_UserId",
                table: "GuestHouses",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_LogTable_BookingId",
                table: "LogTable",
                column: "BookingId");

            migrationBuilder.CreateIndex(
                name: "IX_LogTable_UserId",
                table: "LogTable",
                column: "UserId");
